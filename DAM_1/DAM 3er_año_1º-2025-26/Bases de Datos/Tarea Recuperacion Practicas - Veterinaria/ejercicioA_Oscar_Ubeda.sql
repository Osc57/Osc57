...
/*9*/
ALTER TABLE JUGADORES ADD avatar_url TEXT(200);

/*10*/
ALTER TABLE JUGADORES DROP CONSTRAINT ck_nivel_cuenta;

/*11*/
ALTER TABLE VIDEOJUEGOS ADD fecha_inicio_temp DATE, ADD fecha_fin_temp DATE;

/*12*/
ALTER TABLE VIDEOJUEGOS ADD CONSTRAINT ck_periodo_gratis CHECK (fecha_fin_temp > fecha_inicio_temp);

/*13*/
ALTER TABLE PARTIDAS DROP COLUMN mapa_escenario;

/*14*/
ALTER TABLE PARTICIPACIONES ADD CONSTRAINT ck_partida_finalizada CHECK ((resultado NOT IN ('VICTORIA', 'DERROTA')) OR (tiempo_jugado_sec > 0));
