...
from PyQt6.QtWidgets import QApplication, QCheckBox, QHBoxLayout, QLabel, QLineEdit, QMainWindow, QPushButton, QRadioButton, QVBoxLayout, QWidget, QGroupBox;
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        box1 = QRadioButton("Opción 1")
        box2 = QRadioButton("Opción 2")
        box3 = QRadioButton("Opción 3")
