...
Productos (#numero_producto: entero, nombre: cadena(30), precio_venta: decimal, stock: entero,
id_categoria: cadena(2))
Categorias
...
Detalles_Pedidos (#numero_pedido:entero, #numero_producto:entero, cantidad:entero, precio:decimal(2
decimales))
Pedidos Producto*/
